...
namespace DCP.Resources
{
    public partial class PatternRecognitionEasy : Form
    {
        ...
        public PatternRecognitionEasy()
        {
            ...
            {
                new Question { QuestionText = "What comes next in the sequence: 10, 20, 30, 40, ?", A = "45", B = "50", C = "55", D = "60", CorrectAnswer = "B" },
                new Question { QuestionText = "What comes next in the sequence: 2, 5, 8, 11, ?", A = "12", B = "14", C = "15", D = "13", CorrectAnswer = "D" },
