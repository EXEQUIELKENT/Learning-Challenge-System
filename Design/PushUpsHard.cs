...
namespace DCP
{
    public partial class PushUpsHard : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataSuccess(string username, int reps, string time)
        {
            ...
            var newChallengeData = new
            {
                Date = date,
                FormTitle = "Push Up (Hard)",
                Reps = $"Completed {reps}", // For PushUpHard
                Time = time
            };
        ...
        {
            string url = "https://www.youtube.com/watch?v=IODxDxX7oi4";
        ...
        private void PushUpsHard_Load(object sender, EventArgs e)
        {
