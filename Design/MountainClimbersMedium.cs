...
namespace DCP
{
    public partial class MountainClimbersMedium : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Mountain Climbers (Medium)",
        ...
        private void MountainClimbersMedium_Load(object sender, EventArgs e)
        {
