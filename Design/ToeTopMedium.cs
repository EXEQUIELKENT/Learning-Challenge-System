...
namespace DCP
{
    public partial class ToeTopMedium : Form
    {
        private Timer timer;
        private int progressDuration = 180; // total time for progress bar in seconds
        ...
        {
            string url = "https://www.youtube.com/watch?v=S5EATvEM21Y";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@fitnessblender";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
        ...
        private void ToeTopMedium_Load(object sender, EventArgs e)
        {
