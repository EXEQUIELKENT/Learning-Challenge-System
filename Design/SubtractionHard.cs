...
namespace DCP
{
    public partial class SubtractionHard : Form
    {
        ...
        public SubtractionHard()
        {
            ...
            {
                new Question { QuestionText = "950 - 320 - 210 = ?", A = "420", B = "419", C = "421", D = "422", CorrectAnswer = "A" },
                new Question { QuestionText = "875 - 250 - 125 = ?", A = "500", B = "501", C = "502", D = "503", CorrectAnswer = "A" },
                new Question { QuestionText = "999 - 333 - 222 = ?", A = "443", B = "444", C = "445", D = "446", CorrectAnswer = "B" },
                new Question { QuestionText = "800 - 250 - 200 = ?", A = "349", B = "350", C = "351", D = "352", CorrectAnswer = "B" },
                new Question { QuestionText = "740 - 310 - 120 = ?", A = "308", B = "309", C = "310", D = "311", CorrectAnswer = "C" },

                new Question { QuestionText = "900 - 400 - 250 = ?", A = "248", B = "249", C = "250", D = "251", CorrectAnswer = "C" },
                new Question { QuestionText = "860 - 310 - 215 = ?", A = "333", B = "334", C = "335", D = "336", CorrectAnswer = "B" },
                new Question { QuestionText = "780 - 220 - 150 = ?", A = "408", B = "409", C = "410", D = "411", CorrectAnswer = "C" },
                new Question { QuestionText = "640 - 230 - 210 = ?", A = "198", B = "199", C = "200", D = "201", CorrectAnswer = "C" },
                new Question { QuestionText = "725 - 315 - 205 = ?", A = "204", B = "205", C = "206", D = "207", CorrectAnswer = "B" },

                new Question { QuestionText = "999 - 499 - 300 = ?", A = "199", B = "200", C = "201", D = "202", CorrectAnswer = "B" },
                new Question { QuestionText = "830 - 240 - 390 = ?", A = "198", B = "199", C = "200", D = "201", CorrectAnswer = "C" },
                new Question { QuestionText = "910 - 510 - 190 = ?", A = "208", B = "209", C = "210", D = "211", CorrectAnswer = "C" },
                new Question { QuestionText = "760 - 360 - 100 = ?", A = "299", B = "300", C = "301", D = "302", CorrectAnswer = "B" },
                new Question { QuestionText = "870 - 430 - 320 = ?", A = "118", B = "119", C = "120", D = "121", CorrectAnswer = "C" },

                new Question { QuestionText = "654 - 234 - 210 = ?", A = "208", B = "209", C = "210", D = "211", CorrectAnswer = "B" },
                new Question { QuestionText = "700 - 280 - 220 = ?", A = "198", B = "199", C = "200", D = "201", CorrectAnswer = "C" },
                new Question { QuestionText = "915 - 415 - 305 = ?", A = "194", B = "195", C = "196", D = "197", CorrectAnswer = "B" },
                new Question { QuestionText = "999 - 555 - 333 = ?", A = "110", B = "111", C = "112", D = "113", CorrectAnswer = "B" },
                new Question { QuestionText = "880 - 450 - 310 = ?", A = "118", B = "119", C = "120", D = "121", CorrectAnswer = "C" },

                new Question { QuestionText = "760 - 250 - 250 = ?", A = "258", B = "259", C = "260", D = "261", CorrectAnswer = "C" },
                new Question { QuestionText = "810 - 310 - 190 = ?", A = "310", B = "309", C = "312", D = "311", CorrectAnswer = "D" },
                new Question { QuestionText = "940 - 540 - 290 = ?", A = "108", B = "109", C = "110", D = "111", CorrectAnswer = "C" },
                new Question { QuestionText = "855 - 455 - 250 = ?", A = "148", B = "149", C = "150", D = "151", CorrectAnswer = "C" },
                new Question { QuestionText = "978 - 470 - 200 = ?", A = "308", B = "309", C = "310", D = "311", CorrectAnswer = "B" },

                new Question { QuestionText = "925 - 325 - 175 = ?", A = "424", B = "425", C = "426", D = "427", CorrectAnswer = "B" },
                new Question { QuestionText = "875 - 375 - 275 = ?", A = "224", B = "225", C = "226", D = "227", CorrectAnswer = "B" },
                new Question { QuestionText = "990 - 490 - 400 = ?", A = "98", B = "99", C = "100", D = "101", CorrectAnswer = "C" },
                new Question { QuestionText = "940 - 320 - 410 = ?", A = "208", B = "209", C = "210", D = "211", CorrectAnswer = "C" },
                new Question { QuestionText = "720 - 250 - 150 = ?", A = "318", B = "319", C = "320", D = "321", CorrectAnswer = "C" },

                new Question { QuestionText = "810 - 260 - 190 = ?", A = "358", B = "359", C = "360", D = "361", CorrectAnswer = "C" },
                new Question { QuestionText = "680 - 250 - 120 = ?", A = "308", B = "309", C = "310", D = "311", CorrectAnswer = "C" },
                new Question { QuestionText = "930 - 430 - 250 = ?", A = "248", B = "249", C = "250", D = "251", CorrectAnswer = "C" },
                new Question { QuestionText = "950 - 450 - 350 = ?", A = "148", B = "149", C = "150", D = "151", CorrectAnswer = "C" },
                new Question { QuestionText = "720 - 310 - 210 = ?", A = "198", B = "199", C = "200", D = "201", CorrectAnswer = "C" },

                new Question { QuestionText = "888 - 444 - 222 = ?", A = "221", B = "222", C = "223", D = "224", CorrectAnswer = "B" },
                new Question { QuestionText = "910 - 510 - 310 = ?", A = "90", B = "89", C = "92", D = "91", CorrectAnswer = "A" },
                new Question { QuestionText = "930 - 520 - 300 = ?", A = "110", B = "109", C = "112", D = "111", CorrectAnswer = "A" },
                new Question { QuestionText = "940 - 330 - 210 = ?", A = "398", B = "399", C = "400", D = "401", CorrectAnswer = "C" },
                new Question { QuestionText = "999 - 222 - 555 = ?", A = "221", B = "222", C = "223", D = "224", CorrectAnswer = "B" },
            };
