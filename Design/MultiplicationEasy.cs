...
namespace DCP
{
    public partial class MultiplicationEasy : Form
    {
        ...
        public MultiplicationEasy()
        {
            ...
            {
                new Question { QuestionText = "3 × 5 = ?", A = "15", B = "20", C = "10", D = "25", CorrectAnswer = "A" },
                new Question { QuestionText = "4 × 6 = ?", A = "30", B = "24", C = "28", D = "26", CorrectAnswer = "B" },
                new Question { QuestionText = "2 × 8 = ?", A = "18", B = "14", C = "16", D = "12", CorrectAnswer = "C" },
                new Question { QuestionText = "7 × 3 = ?", A = "20", B = "21", C = "18", D = "24", CorrectAnswer = "B" },
                new Question { QuestionText = "9 × 2 = ?", A = "19", B = "16", C = "18", D = "20", CorrectAnswer = "C" },

                new Question { QuestionText = "5 × 4 = ?", A = "25", B = "20", C = "15", D = "30", CorrectAnswer = "B" },
                new Question { QuestionText = "6 × 6 = ?", A = "36", B = "30", C = "32", D = "34", CorrectAnswer = "A" },
                new Question { QuestionText = "8 × 3 = ?", A = "21", B = "22", C = "23", D = "24", CorrectAnswer = "D" },
                new Question { QuestionText = "9 × 5 = ?", A = "45", B = "44", C = "40", D = "46", CorrectAnswer = "A" },
                new Question { QuestionText = "7 × 4 = ?", A = "27", B = "29", C = "28", D = "30", CorrectAnswer = "C" },

                new Question { QuestionText = "6 × 2 = ?", A = "10", B = "12", C = "11", D = "13", CorrectAnswer = "B" },
                new Question { QuestionText = "5 × 8 = ?", A = "45", B = "40", C = "42", D = "44", CorrectAnswer = "B" },
                new Question { QuestionText = "3 × 9 = ?", A = "27", B = "29", C = "28", D = "25", CorrectAnswer = "A" },
                new Question { QuestionText = "4 × 7 = ?", A = "26", B = "28", C = "27", D = "29", CorrectAnswer = "B" },
                new Question { QuestionText = "2 × 9 = ?", A = "16", B = "18", C = "20", D = "19", CorrectAnswer = "B" },

                new Question { QuestionText = "8 × 2 = ?", A = "16", B = "12", C = "18", D = "20", CorrectAnswer = "A" },
                new Question { QuestionText = "6 × 3 = ?", A = "19", B = "18", C = "17", D = "20", CorrectAnswer = "B" },
                new Question { QuestionText = "5 × 5 = ?", A = "20", B = "24", C = "25", D = "26", CorrectAnswer = "C" },
                new Question { QuestionText = "9 × 3 = ?", A = "26", B = "27", C = "28", D = "25", CorrectAnswer = "B" },
                new Question { QuestionText = "7 × 2 = ?", A = "13", B = "14", C = "15", D = "16", CorrectAnswer = "B" },

                new Question { QuestionText = "4 × 9 = ?", A = "35", B = "36", C = "38", D = "34", CorrectAnswer = "B" },
                new Question { QuestionText = "6 × 5 = ?", A = "32", B = "30", C = "34", D = "28", CorrectAnswer = "B" },
                new Question { QuestionText = "8 × 4 = ?", A = "31", B = "33", C = "32", D = "34", CorrectAnswer = "C" },
                new Question { QuestionText = "7 × 6 = ?", A = "40", B = "41", C = "42", D = "43", CorrectAnswer = "C" },
                new Question { QuestionText = "9 × 4 = ?", A = "34", B = "35", C = "36", D = "37", CorrectAnswer = "C" },

                new Question { QuestionText = "3 × 7 = ?", A = "21", B = "20", C = "22", D = "24", CorrectAnswer = "A" },
                new Question { QuestionText = "2 × 6 = ?", A = "13", B = "14", C = "12", D = "16", CorrectAnswer = "C" },
                new Question { QuestionText = "8 × 5 = ?", A = "39", B = "40", C = "41", D = "42", CorrectAnswer = "B" },
                new Question { QuestionText = "9 × 6 = ?", A = "52", B = "53", C = "54", D = "55", CorrectAnswer = "C" },
                new Question { QuestionText = "7 × 8 = ?", A = "54", B = "55", C = "56", D = "57", CorrectAnswer = "C" },

                new Question { QuestionText = "5 × 9 = ?", A = "44", B = "45", C = "46", D = "47", CorrectAnswer = "B" },
                new Question { QuestionText = "6 × 8 = ?", A = "47", B = "48", C = "49", D = "50", CorrectAnswer = "B" },
                new Question { QuestionText = "4 × 4 = ?", A = "14", B = "15", C = "16", D = "17", CorrectAnswer = "C" },
                new Question { QuestionText = "2 × 7 = ?", A = "13", B = "14", C = "12", D = "15", CorrectAnswer = "B" },
                new Question { QuestionText = "3 × 8 = ?", A = "24", B = "26", C = "25", D = "27", CorrectAnswer = "A" },

                new Question { QuestionText = "9 × 7 = ?", A = "63", B = "62", C = "64", D = "65", CorrectAnswer = "A" },
                new Question { QuestionText = "8 × 6 = ?", A = "48", B = "46", C = "47", D = "49", CorrectAnswer = "A" },
                new Question { QuestionText = "5 × 7 = ?", A = "36", B = "35", C = "37", D = "38", CorrectAnswer = "B" },
                new Question { QuestionText = "6 × 9 = ?", A = "52", B = "53", C = "54", D = "55", CorrectAnswer = "C" },
                new Question { QuestionText = "4 × 8 = ?", A = "32", B = "33", C = "34", D = "31", CorrectAnswer = "A" },
            };
