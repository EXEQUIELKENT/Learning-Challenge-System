...
{
    public partial class GlutesBridgesHard : Form
    {
        private Timer timer;
        ...
        //Button Codes
        private void GlutesBridgesHard_Load(object sender, EventArgs e)
        {
