...
{
    public partial class GlutesBridgesMedium : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Glutes Bridges (Medium)",
        ...
        public void SaveChallengeDataSuccess(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Glute Bridges (Medium)",
        ...
        //Button Codes
        private void GlutesBridgesMedium_Load(object sender, EventArgs e)
        {
