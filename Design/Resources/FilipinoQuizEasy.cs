...
{
    public partial class FilipinoQuizEasy : Form
    {
        private Timer timer;
        ...
        public FilipinoQuizEasy()
        {
            InitializeComponent();
            questions = new List<Question>
            {
                new Question { QuestionText = "Ano ang pambansang sayaw ng Pilipinas?", A = "Tinikling", B = "Pandanggo sa Ilaw", C = "Kundiman", D = "Samba", CorrectAnswer = "A" },
                new Question { QuestionText = "Ano ang tawag sa tradisyonal na pagkain ng Pilipinas na may kasamang suka at baboy?", A = "Lechon", B = "Sinigang", C = "Adobo", D = "Pancit", CorrectAnswer = "C" },
                new Question { QuestionText = "Ano ang tinatawag na pinaka-kilalang tanawin sa Pilipinas na matatagpuan sa Banaue?", A = "Chocolate Hills", B = "Taal Volcano", C = "Rice Terraces", D = "Mayon Volcano", CorrectAnswer = "C" },
                new Question { QuestionText = "Anong buwan ipinagdiriwang ang Araw ng Kalayaan ng Pilipinas?", A = "Agosto", B = "Mayo", C = "Hunyo", D = "Disyembre", CorrectAnswer = "C" },
                new Question { QuestionText = "Ano ang pangunahing relihiyon sa Pilipinas?", A = "Islam", B = "Buddhism", C = "Kristiyanismo", D = "Hinduism", CorrectAnswer = "C" },

                new Question { QuestionText = "Ano ang pambansang bulaklak ng Pilipinas?", A = "Sampaguita", B = "Gumamela", C = "Waling-waling", D = "Rosal", CorrectAnswer = "A" },
                new Question { QuestionText = "Ano ang tawag sa tradisyunal na kasuotan ng mga lalaki sa Pilipinas?", A = "Baro’t Saya", B = "Barong Tagalog", C = "Kimona", D = "Terno", CorrectAnswer = "B" },
                new Question { QuestionText = "Ano ang tawag sa pambansang puno ng Pilipinas?", A = "Mango", B = "Acacia", C = "Narra", D = "Mahogany", CorrectAnswer = "C" },
                new Question { QuestionText = "Sino ang kinikilalang pambansang bayani ng Pilipinas?", A = "Andres Bonifacio", B = "Jose Rizal", C = "Emilio Aguinaldo", D = "Apolinario Mabini", CorrectAnswer = "B" },
                new Question { QuestionText = "Ano ang tawag sa sikat na sasakyang pampubliko sa Pilipinas?", A = "Bus", B = "Tricycle", C = "Jeepney", D = "Taxi", CorrectAnswer = "C" },
                
                new Question { QuestionText = "Ano ang kulay ng araw sa watawat ng Pilipinas?", A = "Berde", B = "Pula", C = "Dilaw", D = "Asul", CorrectAnswer = "C" },
                new Question { QuestionText = "Ano ang tawag sa pinakamatandang lungsod sa Pilipinas?", A = "Maynila", B = "Davao", C = "Cebu", D = "Baguio", CorrectAnswer = "C" },
                new Question { QuestionText = "Saan matatagpuan ang sikat na Chocolate Hills?", A = "Palawan", B = "Bohol", C = "Cebu", D = "Leyte", CorrectAnswer = "B" },
                new Question { QuestionText = "Ano ang pangunahing wika sa Pilipinas?", A = "Ilocano", B = "Cebuano", C = "Tagalog", D = "Hiligaynon", CorrectAnswer = "C" },
                new Question { QuestionText = "Ano ang tawag sa pambansang isda ng Pilipinas?", A = "Tilapia", B = "Bangus", C = "Lapu-lapu", D = "Tamban", CorrectAnswer = "B" },
                
                new Question { QuestionText = "Ano ang tawag sa sikat na kasuotang pambabae sa Pilipinas?", A = "Terno", B = "Kimona", C = "Saya", D = "Balintawak", CorrectAnswer = "A" },
                new Question { QuestionText = "Ano ang tawag sa tradisyunal na paraan ng panghuhuli ng isda gamit ang lambat?", A = "Pangangawil", B = "Pangangapa", C = "Lambat", D = "Paglalambat", CorrectAnswer = "D" },
                new Question { QuestionText = "Ano ang tawag sa tradisyunal na lutuing Pilipino na may sabaw at maasim na lasa?", A = "Kare-kare", B = "Sinigang", C = "Adobo", D = "Menudo", CorrectAnswer = "B" },
                new Question { QuestionText = "Ano ang pinakamataas na bundok sa Pilipinas?", A = "Mount Pulag", B = "Mount Apo", C = "Mount Mayon", D = "Mount Kitanglad", CorrectAnswer = "B" },
                new Question { QuestionText = "Ano ang pambansang hayop ng Pilipinas?", A = "Kalabaw", B = "Agila", C = "Tarsier", D = "Dugong", CorrectAnswer = "A" },
                
                new Question { QuestionText = "Ano ang pangalan ng sikat na makata na sumulat ng Florante at Laura?", A = "Jose Rizal", B = "Francisco Balagtas", C = "Andres Bonifacio", D = "Emilio Jacinto", CorrectAnswer = "B" },
                new Question { QuestionText = "Ano ang tawag sa sikat na anyong tubig na matatagpuan sa Palawan?", A = "Maria Cristina Falls", B = "Pagsanjan Falls", C = "Underground River", D = "Hinulugang Taktak", CorrectAnswer = "C" },
                new Question { QuestionText = "Ano ang pinakamalaking pangkat-etniko sa Pilipinas?", A = "Ilocano", B = "Cebuano", C = "Tagalog", D = "Kapampangan", CorrectAnswer = "C" },
                new Question { QuestionText = "Ano ang tawag sa tradisyunal na musikang Pilipino na may kasamang sayaw at awit?", A = "Kundiman", B = "Harana", C = "Balitaw", D = "Tinikling", CorrectAnswer = "C" },
                new Question { QuestionText = "Saan matatagpuan ang Mayon Volcano?", A = "Cebu", B = "Albay", C = "Davao", D = "Zambales", CorrectAnswer = "B" },
                
                new Question { QuestionText = "Ano ang tawag sa sinaunang alpabeto ng Pilipinas?", A = "Latin", B = "Baybayin", C = "Katakana", D = "Alibata", CorrectAnswer = "B" },
                new Question { QuestionText = "Ano ang tawag sa makasaysayang lugar kung saan itinaas ang watawat ng Pilipinas noong Hunyo 12, 1898?", A = "Luneta Park", B = "Barasoain Church", C = "Aguinaldo Shrine", D = "Fort Santiago", CorrectAnswer = "C" },
                new Question { QuestionText = "Ano ang tawag sa ipinagmamalaking sasakyang pandagat ng mga ninuno nating Pilipino?", A = "Bangka", B = "Galleon", C = "Balangay", D = "Katig", CorrectAnswer = "C" },
                new Question { QuestionText = "Ano ang pangalan ng yumaong aktor na tinaguriang 'Hari ng Pelikulang Pilipino'?", A = "Fernando Poe Jr.", B = "Dolphy", C = "Ramon Revilla Sr.", D = "Eddie Garcia", CorrectAnswer = "A" },
                new Question { QuestionText = "Ano ang tradisyunal na kasangkapan na ginagamit sa paggawa ng banig?", A = "Bamboo", B = "Buli", C = "Rattan", D = "Abaka", CorrectAnswer = "B" },
                
                new Question { QuestionText = "Ano ang tinaguriang 'Pambansang Sasakyan' ng Pilipinas?", A = "Kalesa", B = "Tricycle", C = "Jeepney", D = "Bus", CorrectAnswer = "C" },
                new Question { QuestionText = "Ano ang kilalang sining ng pag-ukit sa kahoy sa Paete, Laguna?", A = "Paghahabi", B = "Pag-uukit", C = "Pintura", D = "Pagpapalayok", CorrectAnswer = "B" },
                new Question { QuestionText = "Ano ang pangalan ng tinaguriang 'Ama ng Katipunan'?", A = "Jose Rizal", B = "Andres Bonifacio", C = "Emilio Aguinaldo", D = "Marcelo H. del Pilar", CorrectAnswer = "B" },
                new Question { QuestionText = "Ano ang tawag sa kasuotan ng mga Pilipino noong panahon ng Kastila?", A = "Barong Tagalog", B = "Traje de Mestiza", C = "Tapis", D = "Saya", CorrectAnswer = "B" },
                new Question { QuestionText = "Ano ang pinakasikat na pista sa Cebu?", A = "Sinulog Festival", B = "Pahiyas Festival", C = "Panagbenga Festival", D = "Ati-Atihan Festival", CorrectAnswer = "A" }
            };
