...
{
    public partial class GrammarEasy : Form
    {
        private Timer timer;
        ...
        public GrammarEasy()
        {
            ...
            {
                new Question { QuestionText = "___ is your favorite color?", A = "When", B = "Why", C = "What", D = "Where", CorrectAnswer = "C" },
                new Question { QuestionText = "___ do you usually wake up?", A = "Why", B = "How", C = "When", D = "Where", CorrectAnswer = "C" },
                new Question { QuestionText = "___ is calling on the phone?", A = "Who", B = "Why", C = "Where", D = "What", CorrectAnswer = "A" },
                new Question { QuestionText = "___ are you going for vacation?", A = "Which", B = "Where", C = "How", D = "What", CorrectAnswer = "B" },
                new Question { QuestionText = "___ are you late for the meeting?", A = "Why", B = "Who", C = "How", D = "Where", CorrectAnswer = "A" },

                new Question { QuestionText = "___ do you want to eat for dinner?", A = "Who", B = "What", C = "Where", D = "Why", CorrectAnswer = "B" },
                new Question { QuestionText = "___ is knocking at the door?", A = "Who", B = "When", C = "Why", D = "Which", CorrectAnswer = "A" },
                new Question { QuestionText = "___ is your favorite movie?", A = "How", B = "Where", C = "What", D = "Who", CorrectAnswer = "C" },
                new Question { QuestionText = "___ are you going to the mall?", A = "When", B = "Why", C = "Where", D = "Which", CorrectAnswer = "A" },
                new Question { QuestionText = "___ do you go to school?", A = "Who", B = "When", C = "Where", D = "How", CorrectAnswer = "D" },

                new Question { QuestionText = "___ do you call this object?", A = "Which", B = "What", C = "Where", D = "Why", CorrectAnswer = "B" },
                new Question { QuestionText = "___ do birds fly?", A = "How", B = "When", C = "Why", D = "Where", CorrectAnswer = "A" },
                new Question { QuestionText = "___ is your best friend?", A = "How", B = "Who", C = "Where", D = "What", CorrectAnswer = "B" },
                new Question { QuestionText = "___ is your house located?", A = "Why", B = "When", C = "Where", D = "Which", CorrectAnswer = "C" },
                new Question { QuestionText = "___ do you prefer, coffee or tea?", A = "Which", B = "Where", C = "When", D = "How", CorrectAnswer = "A" },

                new Question { QuestionText = "___ does she live?", A = "Who", B = "What", C = "Where", D = "Why", CorrectAnswer = "C" },
                new Question { QuestionText = "___ do you need my help?", A = "Why", B = "Who", C = "When", D = "Which", CorrectAnswer = "A" },
                new Question { QuestionText = "___ is the best way to learn English?", A = "Where", B = "When", C = "Why", D = "How", CorrectAnswer = "D" },
                new Question { QuestionText = "___ is the last person who entered the room?", A = "Who", B = "When", C = "Where", D = "How", CorrectAnswer = "A" },
                new Question { QuestionText = "___ did you put your phone?", A = "Who", B = "Where", C = "Why", D = "How", CorrectAnswer = "B" },

                new Question { QuestionText = "___ will you visit your grandparents?", A = "Who", B = "When", C = "Where", D = "Why", CorrectAnswer = "B" },
                new Question { QuestionText = "___ are the keys to my car?", A = "Who", B = "Where", C = "When", D = "Why", CorrectAnswer = "B" },
                new Question { QuestionText = "___ does she want to change her dress?", A = "Who", B = "Why", C = "When", D = "Where", CorrectAnswer = "B" },
                new Question { QuestionText = "___ is your dream job?", A = "How", B = "Who", C = "What", D = "Where", CorrectAnswer = "C" },
                new Question { QuestionText = "___ is taller, you or your brother?", A = "Which", B = "What", C = "Who", D = "Where", CorrectAnswer = "C" },

                new Question { QuestionText = "___ do you usually go on Sundays?", A = "How", B = "When", C = "Where", D = "What", CorrectAnswer = "C" },
                new Question { QuestionText = "___ is playing the guitar in the other room?", A = "Who", B = "Where", C = "When", D = "What", CorrectAnswer = "A" },
                new Question { QuestionText = "___ do you want for your birthday?", A = "How", B = "Why", C = "Where", D = "What", CorrectAnswer = "D" },
                new Question { QuestionText = "___ should I wear to the party?", A = "Who", B = "What", C = "Where", D = "Which", CorrectAnswer = "D" },
                new Question { QuestionText = "___ do you think will win the game?", A = "Who", B = "Where", C = "When", D = "Why", CorrectAnswer = "A" },

                new Question { QuestionText = "___ does he always arrive late?", A = "Who", B = "Why", C = "Where", D = "When", CorrectAnswer = "B" },
                new Question { QuestionText = "___ is your favorite book?", A = "Who", B = "What", C = "Where", D = "Why", CorrectAnswer = "B" },
                new Question { QuestionText = "___ do you usually study?", A = "Who", B = "When", C = "Where", D = "How", CorrectAnswer = "C" },
                new Question { QuestionText = "___ do you want to travel next summer?", A = "Who", B = "What", C = "Where", D = "When", CorrectAnswer = "C" },
                new Question { QuestionText = "___ is your teacher's name?", A = "Who", B = "What", C = "Where", D = "Why", CorrectAnswer = "A" },

                new Question { QuestionText = "___ are you going to the store?", A = "Who", B = "When", C = "Where", D = "Why", CorrectAnswer = "B" },
                new Question { QuestionText = "___ does she prefer to wear dresses?", A = "Who", B = "When", C = "Where", D = "Why", CorrectAnswer = "D" },
                new Question { QuestionText = "___ is taller, John or Jake?", A = "Who", B = "What", C = "Where", D = "Why", CorrectAnswer = "A" },
                new Question { QuestionText = "___ do you like to do on weekends?", A = "Who", B = "What", C = "Where", D = "When", CorrectAnswer = "B" },
                new Question { QuestionText = "___ should I bring to the picnic?", A = "Who", B = "What", C = "Where", D = "Which", CorrectAnswer = "D" }
            };
