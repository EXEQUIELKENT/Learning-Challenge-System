...
{
    public partial class DiamondPushUpEasy : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Diamond Push Ups (Easy)",
        ...
        //Button Codes
        private void DiamondPushUpEasy_Load(object sender, EventArgs e)
        {
