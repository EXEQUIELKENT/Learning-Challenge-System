...
{
    public partial class JumpingSquatMedium : Form
    {
        private Timer timer;
        ...
        //Button Codes
        private void JumpingSquatMedium_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://www.youtube.com/watch?v=BRfxI2Es2lE";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@PureGymVideo";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
