...
{
    public partial class MindfulBreathingMedium : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataSuccess(string username, string status, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Mindful Breathing (Medium)",
        ...
        {
            string url = "https://www.youtube.com/watch?v=thcEuMDWxoI&t=65s";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@MingyurRinpoche";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
