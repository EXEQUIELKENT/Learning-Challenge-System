...
{
    public partial class StandingSideLegRaisesEasy : Form
    {
        private Timer timer;
        ...
        public StandingSideLegRaisesEasy()
        {
            InitializeComponent();
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Standing Side Leg Raises (Easy)",
        ...
        //Button Codes
        private void StandingSideLegRaisesEasy_Load(object sender, EventArgs e)
        {
