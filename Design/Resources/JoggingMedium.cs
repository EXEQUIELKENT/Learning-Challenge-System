...
{
    public partial class JoggingMedium : Form
    {
        private Timer timer;
        ...
        //Button Codes
        private void JoggingMedium_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://www.youtube.com/watch?v=_kGESn8ArrU";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@gtn";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
