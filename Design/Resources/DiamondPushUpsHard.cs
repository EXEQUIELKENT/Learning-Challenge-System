...
{
    public partial class DiamondPushUpsHard : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Diamond Push Ups (Hard)",
        ...
        //Button Codes
        private void DiamondPushUpsHard_Load(object sender, EventArgs e)
        {
