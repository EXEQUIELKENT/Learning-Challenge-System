...
{
    public partial class HighKneesMedium : Form
    {
        private Timer timer;
        ...
        {
            string url = "https://www.youtube.com/watch?v=OUgsJ8-Vi0E";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@airrosti";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
