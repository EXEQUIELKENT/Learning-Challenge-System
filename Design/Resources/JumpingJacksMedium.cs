...
{
    public partial class JumpingJacksMedium : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataSuccess(string username, string status, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Jumping Jacks (Medium)",
        ...
        //Button Codes
        private void JumpingJacksMedium_Load(object sender, EventArgs e)
        {
