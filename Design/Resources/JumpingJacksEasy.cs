...
{
    public partial class JumpingJacksEasy : Form
    {
        private Timer timer;
        ...
        //Button Codes
        private void JumpingJacksEasy_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://www.youtube.com/watch?v=nGaXj3kkmrU";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@babylon7567";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
