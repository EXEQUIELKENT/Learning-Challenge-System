...
{
    public partial class GlutesBridgesEasy : Form
    {
        private Timer timer;
        ...
        //Button Codes
        private void GlutesBridgesEasy_Load(object sender, EventArgs e)
        {
