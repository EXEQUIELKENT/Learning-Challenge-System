...
{
    public partial class StandingSideLegRaisesHard : Form
    {
        private Timer timer;
        ...
        public StandingSideLegRaisesHard()
        {
            InitializeComponent();
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Standing Side Leg Raises (Hard)",
        ...
        //Button Codes
        private void StandingSideLegRaisesHard_Load(object sender, EventArgs e)
        {
