...
{
    public partial class StepUpMedium : Form
    {
        private Timer timer;
        ...
        private void StepUpMedium_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://www.youtube.com/watch?v=wfhXnLILqdk";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@JoonNahPT";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
