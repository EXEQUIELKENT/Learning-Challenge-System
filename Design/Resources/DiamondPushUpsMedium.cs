...
{
    public partial class DiamondPushUpsMedium : Form
    {
        private Timer timer;
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                textBox2.Text = "00:01:00"; // Set the final time
                ...
                SaveChallengeDataFailed(Login.CurrentUsername, timeTaken);
        ...
        public void SaveChallengeDataFailed(string username, string time)
        {
            ...
            {
                Username = username,
                FormTitle = "Diamond Push Ups (Medium)",
                Reps = 0, // For PushUpEasy
                Time = time
            };
        ...
        //BUTTON CODES
        private void DiamondPushUpsMedium_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(textBox1.Text, out int reps))
            {
                ...
                // Displaying the message after the challenge
        ...
        {
            string url = "https://youtu.be/J0DnG1_S92I?si=NlBQ7ZXKCRrnpNQR";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@ScottHermanFitness";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
