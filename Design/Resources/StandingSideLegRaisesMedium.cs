...
{
    public partial class StandingSideLegRaisesMedium : Form
    {
        private Timer timer;
        ...
        public StandingSideLegRaisesMedium()
        {
            InitializeComponent();
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Standing Side Leg Raises (Medium)",
        ...
        //Button Codes
        private void StandingSideLegRaisesMedium_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://www.youtube.com/watch?v=TAih_WDxBOU";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@ExerciseLibraryJoannaSoh";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
