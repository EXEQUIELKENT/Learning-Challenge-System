...
{
    public partial class CalfRaisesMedium : Form
    {
        private Timer timer;
        ...
        //Button Codes
        private void CalfRaisesMedium_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://www.youtube.com/shorts/haHcBAd637E";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@calimove";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
