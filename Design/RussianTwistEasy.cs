...
namespace DCP
{
    public partial class RussianTwistEasy : Form
    {
        private Timer timer;
        ...
        private void RussianTwistEasy_Load(object sender, EventArgs e)
        {
