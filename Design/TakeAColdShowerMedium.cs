...
namespace DCP
{
    public partial class TakeAColdShowerMedium : Form
    {
        private Timer timer;
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SaveChallengeDataSuccess(Login.CurrentUsername, "Completed", textBox2.Text, "Cold Shower (Medium)");
            ...
            if (keyData == Keys.Back)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (timer != null && timer.Enabled) // Assuming 'challengeTimer' is your timer
                    {
                        ...
                        {
                            // Save challenge data to JSON file
                            SaveChallengeDataFailed(Login.CurrentUsername, textBox2.Text, "Cold Shower (Medium)");
