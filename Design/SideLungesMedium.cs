...
namespace DCP
{
    public partial class SideLungesMedium : Form
    {
        private Timer timer;
        ...
        private void SideLungesMedium_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://www.youtube.com/watch?v=rvqLVxYqEvo";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@health";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
