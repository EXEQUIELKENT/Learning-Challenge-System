...
namespace DCP
{
    public partial class BicycleCrunchesHard : Form
    {
        private Timer timer;
        private int progressDuration = 240; // total time for progress bar in seconds
        ...
        public void SaveChallengeDataSuccess(string username, string status, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Bicycle Crunches (Hard)",
        ...
        private void BicycleCrunchesHard_Load(object sender, EventArgs e)
        {
