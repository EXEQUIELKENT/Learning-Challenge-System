...
namespace DCP
{
    public partial class MountainClimbersEasy : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Mountain Climbers (Easy)",
        ...
        private void MountainClimbersEasy_Load(object sender, EventArgs e)
        {
