...
namespace DCP
{
    public partial class ReverseLungesMedium : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Reverse Lunges (Medium)",
        ...
        //Button Codes
        private void ReverseLungesMedium_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://www.youtube.com/watch?v=xrPteyQLGAo";
