...
namespace DCP
{
    public partial class BearCrawlMedium : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Bear Crawl (Medium)",
                Rot = $"Failed {reps}", // For PushUpEasy
                Time = time
            };
        ...
        public void SaveChallengeDataSuccess(string username, int reps, string time)
        {
            ...
            var newChallengeData = new
            {
                Date = date,
                FormTitle = "Bear Crawl (Medium)",
                Rot = $"Completed {reps}", // For PushUpEasy
                Time = time
            };
        ...
        {
            string url = "https://youtu.be/t8XLor7unqU?si=x6Mza9WzIVadEc0W";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@livestrongwomen";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
        ...
        private void BearCrawlMedium_Load(object sender, EventArgs e)
        {
