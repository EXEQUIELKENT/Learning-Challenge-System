...
namespace DCP
{
    public partial class SquatsHard : Form
    {
        private Timer timer;
        ...
        private void SquatsHard_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://www.youtube.com/watch?v=xqvCmoLULNY";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@xhit";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
