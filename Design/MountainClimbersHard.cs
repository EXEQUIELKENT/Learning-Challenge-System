...
namespace DCP
{
    public partial class MountainClimbersHard : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Mountain Climbers (Hard)",
        ...
        private void MountainClimbersHard_Load(object sender, EventArgs e)
        {
