...
namespace DCP
{
    public partial class MultiplicationMedium : Form
    {
        private Timer timer;
        ...
        public MultiplicationMedium()
        {
            InitializeComponent();
            questions = new List<Question>
            {
                new Question { QuestionText = "12 × 11 = ?", A = "132", B = "122", C = "142", D = "124", CorrectAnswer = "A" },
                new Question { QuestionText = "15 × 14 = ?", A = "200", B = "210", C = "205", D = "215", CorrectAnswer = "B" },
                new Question { QuestionText = "16 × 13 = ?", A = "198", B = "206", C = "208", D = "210", CorrectAnswer = "C" },
                new Question { QuestionText = "18 × 12 = ?", A = "214", B = "216", C = "218", D = "220", CorrectAnswer = "B" },
                new Question { QuestionText = "17 × 15 = ?", A = "250", B = "255", C = "260", D = "255", CorrectAnswer = "B" },

                new Question { QuestionText = "14 × 16 = ?", A = "224", B = "226", C = "228", D = "230", CorrectAnswer = "A" },
                new Question { QuestionText = "13 × 17 = ?", A = "220", B = "221", C = "222", D = "221", CorrectAnswer = "C" },
                new Question { QuestionText = "19 × 12 = ?", A = "228", B = "230", C = "226", D = "229", CorrectAnswer = "A" },
                new Question { QuestionText = "15 × 16 = ?", A = "235", B = "240", C = "245", D = "240", CorrectAnswer = "B" },
                new Question { QuestionText = "18 × 14 = ?", A = "248", B = "252", C = "254", D = "250", CorrectAnswer = "B" },

                new Question { QuestionText = "16 × 15 = ?", A = "230", B = "235", C = "240", D = "245", CorrectAnswer = "C" },
                new Question { QuestionText = "12 × 18 = ?", A = "215", B = "216", C = "217", D = "218", CorrectAnswer = "B" },
                new Question { QuestionText = "14 × 19 = ?", A = "266", B = "264", C = "262", D = "268", CorrectAnswer = "A" },
                new Question { QuestionText = "17 × 16 = ?", A = "272", B = "274", C = "276", D = "278", CorrectAnswer = "C" },
                new Question { QuestionText = "13 × 15 = ?", A = "195", B = "190", C = "185", D = "200", CorrectAnswer = "A" },

                new Question { QuestionText = "19 × 13 = ?", A = "247", B = "246", C = "245", D = "248", CorrectAnswer = "D" },
                new Question { QuestionText = "12 × 17 = ?", A = "204", B = "200", C = "202", D = "204", CorrectAnswer = "A" },
                new Question { QuestionText = "18 × 15 = ?", A = "270", B = "275", C = "280", D = "272", CorrectAnswer = "A" },
                new Question { QuestionText = "16 × 17 = ?", A = "270", B = "272", C = "274", D = "276", CorrectAnswer = "D" },
                new Question { QuestionText = "14 × 18 = ?", A = "252", B = "254", C = "250", D = "256", CorrectAnswer = "A" },

                new Question { QuestionText = "15 × 19 = ?", A = "285", B = "280", C = "290", D = "295", CorrectAnswer = "A" },
                new Question { QuestionText = "17 × 14 = ?", A = "238", B = "236", C = "234", D = "240", CorrectAnswer = "D" },
                new Question { QuestionText = "16 × 18 = ?", A = "288", B = "290", C = "286", D = "292", CorrectAnswer = "A" },
                new Question { QuestionText = "19 × 15 = ?", A = "280", B = "285", C = "290", D = "295", CorrectAnswer = "B" },
                new Question { QuestionText = "12 × 19 = ?", A = "228", B = "226", C = "230", D = "232", CorrectAnswer = "A" },

                new Question { QuestionText = "13 × 18 = ?", A = "234", B = "236", C = "238", D = "240", CorrectAnswer = "B" },
                new Question { QuestionText = "14 × 17 = ?", A = "238", B = "240", C = "236", D = "242", CorrectAnswer = "A" },
                new Question { QuestionText = "15 × 16 = ?", A = "235", B = "240", C = "245", D = "250", CorrectAnswer = "B" },
                new Question { QuestionText = "18 × 13 = ?", A = "230", B = "234", C = "236", D = "238", CorrectAnswer = "B" },
                new Question { QuestionText = "17 × 15 = ?", A = "255", B = "250", C = "252", D = "258", CorrectAnswer = "A" },

                new Question { QuestionText = "19 × 12 = ?", A = "228", B = "226", C = "230", D = "232", CorrectAnswer = "A" },
                new Question { QuestionText = "16 × 14 = ?", A = "224", B = "226", C = "228", D = "230", CorrectAnswer = "C" },
                new Question { QuestionText = "15 × 17 = ?", A = "255", B = "250", C = "252", D = "254", CorrectAnswer = "D" },
                new Question { QuestionText = "13 × 16 = ?", A = "208", B = "210", C = "212", D = "214", CorrectAnswer = "C" },
                new Question { QuestionText = "12 × 15 = ?", A = "180", B = "185", C = "182", D = "190", CorrectAnswer = "A" },

                new Question { QuestionText = "14 × 16 = ?", A = "224", B = "226", C = "228", D = "230", CorrectAnswer = "C" },
                new Question { QuestionText = "17 × 13 = ?", A = "220", B = "221", C = "222", D = "223", CorrectAnswer = "B" },
                new Question { QuestionText = "18 × 14 = ?", A = "250", B = "252", C = "254", D = "256", CorrectAnswer = "B" },
                new Question { QuestionText = "19 × 15 = ?", A = "280", B = "285", C = "290", D = "295", CorrectAnswer = "B" },
                new Question { QuestionText = "16 × 12 = ?", A = "192", B = "190", C = "194", D = "196", CorrectAnswer = "A" },
            };
        ...
        public void SaveChallengeDataSuccess(string username, string status, string time, int score)
        {
            ...
            {
                Date = date,
                FormTitle = "Multiplication (Medium)",
