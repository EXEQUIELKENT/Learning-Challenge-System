...
namespace DCP
{
    public partial class RussianTwistMedium : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataFailed(string username, int reps, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Russian Twist (Medium)",
        ...
        private void RussianTwistMedium_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://www.youtube.com/watch?v=DJQGX2J4IVw";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@LeapFitnessOfficial";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
