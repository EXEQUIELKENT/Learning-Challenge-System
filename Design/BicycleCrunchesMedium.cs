...
namespace DCP
{
    public partial class BicycleCrunchesMedium : Form
    {
        private Timer timer;
        ...
        public void SaveChallengeDataSuccess(string username, string status, string time)
        {
            ...
            {
                Date = date,
                FormTitle = "Bicycle Crunches (Medium)",
        ...
        private void BicycleCrunchesMedium_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://youtu.be/1we3bh9uhqY?si=q-P0VAz8MpFYvgSN";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            string url = "https://www.youtube.com/@toneandtighten";
            System.Diagnostics.Process.Start("cmd", $"/c start {url}");
        }
