...
namespace DCP
{
    public partial class GratitudeEasy : Form
    {
        private Timer timer;
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SaveChallengeDataFailed(Login.CurrentUsername, textBox2.Text, "Gratitude (Easy)");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (button1.Text == "DONE")
            {
                ...
                if (EssayrichTextBox1.Text.Length <= 100)
                {
                    // Error message for insufficient content
                    MessageBox.Show("Your gratitude essay must be at least 100 characters long to complete the challenge.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                SaveChallengeDataSuccess(Login.CurrentUsername, "Completed", textBox2.Text, "Gratitude (Easy)");
