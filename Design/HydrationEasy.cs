...
namespace DCP
{
    public partial class HydrationEasy : Form
    {
        private Timer timer;
                ...
                if (timer != null && timer.Enabled) // Assuming 'challengeTimer' is your timer
                {
                    ...
                    if (result2 == DialogResult.Yes)
                    {
                        if (int.TryParse(textBox1.Text, out int glass))
                        {
                            ...
                            MessageBox.Show("Challenge failed as you closed the challenge completing it.", "Challenge Failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
