...
namespace DCP
{
    public partial class HydrationHard : Form
    {
        private Timer timer;
        private int progressDuration = 120; // total time for progress bar in seconds
        ...
        private void HydrationHard_Load(object sender, EventArgs e)
        {
            textBox1.KeyPress += textBox1_KeyPress;
        }
    }
