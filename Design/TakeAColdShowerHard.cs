...
namespace DCP
{
    public partial class TakeAColdShowerHard : Form
    {
        private Timer timer;
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SaveChallengeDataSuccess(Login.CurrentUsername, "Completed", textBox2.Text, "Cold Shower (Hard)");
            ...
            if (keyData == Keys.Back)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (timer != null && timer.Enabled) // Assuming 'challengeTimer' is your timer
                    {
                        ...
                        {
                            // Save challenge data to JSON file
                            SaveChallengeDataFailed(Login.CurrentUsername, textBox2.Text, "Cold Shower (Hard)");
